...
class DataPublicationClient(BaseClient):
    ...
    def __init__(self, base_url, **kwargs):
        self._logger = logging.getLogger("fdrd-encryption-client.DataPublicationClient")
        app_name = kwargs.pop('app_name', config.GLOBUS_DATA_PUBLICATION_CLIENT_NAME)
...
class FRDRAPIClient(BaseClient):
    ...
    def __init__(self):
        self._logger = logging.getLogger("fdrd-encryption-client.FRDR-API-client")
    ...
    def login(self, base_url):
        ...
        try:
            ...
            pub_client = DataPublicationClient(base_url, authorizer=pub_authorizer)
