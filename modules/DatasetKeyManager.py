...
class DatasetKeyManager(object):
    ...
    def generate_key(self):
        ...
        try:
            self._vault_client.create_transit_engine_key_ring(self._key_ring_name, mount_point="transit")
        ...
        key_plaintext = self._vault_client.generate_data_key(self._key_ring_name, mount_point="transit")
