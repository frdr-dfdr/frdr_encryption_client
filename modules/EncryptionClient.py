...
class EncryptionClient(object):
    ...
    def encrypt(self, dataset_uuid):
        ...
        self._dataset_key_manager.save_key("/".join([app_config.VAULT_DATASET_KEY_PATH, self._dataset_key_manager.get_vault_entity_id(), dataset_uuid]))
    ...
    def decrypt(self, url):
        ...
        if requester_uuid == "" :
            ...
            encrypted_data_key_path =  "/".join([app_config.VAULT_DATASET_KEY_PATH, depositor_uuid, dataset_uuid])
        else:
            encrypted_data_key_path = "/".join([app_config.VAULT_DATASET_KEY_PATH, depositor_uuid, dataset_uuid, requester_uuid])
